      ...
      <div className="w-full max-w-md flex flex-col gap-6">
        ...
        {loading ? (
          ...
          <div className="glass-card flex flex-col items-center gap-4 py-12 text-center p-8">
            ...
            <button onClick={() => navigate('/consentimento')} className="gradient-btn rounded-2xl px-8 py-3 text-base font-semibold">
              <Stethoscope className="mr-2 h-5 w-5 inline" /> Iniciar Triagem
            </button>
          </div>
        ) : (
          <div className="flex flex-col gap-3">
            {sessions.map((s) => {
              ...
              return (
                ...
                >
                  <div className={`flex h-12 w-12 items-center justify-center rounded-full border ${styles}`}>
